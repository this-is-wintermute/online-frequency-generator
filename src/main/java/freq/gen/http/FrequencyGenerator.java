...
/**
 * A simple random frequency generator, using specified boundaries and alteration speed.
 */
public class FrequencyGenerator implements Runnable
{
    ...
    /**
     * Returns a new instance of the FrequencyGenerator, which is scheduled to update its frequency every 50ms, using
     * the default settings for the european power grid (50.0 Hz default frequency, max. 200 mHz deviation, max. 50
     * µHz/ms alteration speed.
     */
    ...
    /**
     * Returns the frequency, generated by the previous datapoint plus a random value {@code E{-alteration ..
     * +alteration}}
     */
    public double getFrequency()
    {
        double alteration = (Math.random() * this.maxAlterationBetweenIteration * 2)
                - this.maxAlterationBetweenIteration;
        ...
        LOGGER.debug("New frequency is " + this.previousFrequency);
    ...
    /**
     * Resets to the default frequency (useful in cases you want to test high frequencies, but the random number is
     * currently near the low border).
     */
    public void resetToDefaultFrequency()
    {
        this.previousFrequency = this.defaultFreuency;
    }


    /**
     * Resets the scheduled auto-updating instance to the defaultFrequency
     */
    public void resetTimeBasedInstanceToDefaultFrequency()
    {
        singletonGenerator.resetToDefaultFrequency();
    }
